<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="BAGS.aspx.cs" Inherits="LuxeComasterpage.BAGS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="product">
     ...
     <ul>
      <li>
       <a href="Tote.aspx" title="Furla Stacy Bucket Bag">
      ...
      <li>
          <a href="Rubino.aspx" title="Furla Rubino Mini Crossbody">
            ...
            <li>
                <a href="Capriccio.aspx" title="Furla Capriccio">
